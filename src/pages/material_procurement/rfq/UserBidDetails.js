...
import { changePo_Status, GetRfqDetails, PoSubmit, upload_file } from '../../../helpers/api';
import moment from 'moment-timezone';
import { toast } from 'react-toastify';
import classNames from 'classnames';
import SupplierModalPopup from '../supplier/SupplierModalPopup';


const MaterialProcUserBidsDetails = () => {
    ...
    */
    ...
    const { quote_id, quote_value_id, published_date, drop_address, pickup_address,
        ...
        pickup_city_id, pickup_state_id, site_name,
            ...
            PoSubmit(poForm).then(result => {
                if (result !== undefined) {
                    if (result.data.success) {
                        ...
                        return navigate("/material-procurement/rfq");
                    }
                }
            })
                .catch((e) => {
    ...
    return (
        <>
            ...
            <Modal show={modal} onHide={toggle} dialogClassName={className} size={size} scrollable={scroll}>
                ...
                <Modal.Body>
                    <SupplierModalPopup supplierId={transporterId} />
                </Modal.Body>
            </Modal>
...
export default MaterialProcUserBidsDetails;
