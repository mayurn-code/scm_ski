...
import { Row, Col, OverlayTrigger, Tooltip,Tab, Nav } from 'react-bootstrap';
...
import { OrderDetailsMaterialProcu } from '../../../helpers';
import { toast } from 'react-toastify';
import { useEffect } from 'react';
import MaterialSupplyOrderInvoice from './invoices/Invoices';
...
// order details
const MaterialProcuOrderDetails = (): React$Element<React$FragmentType> => {
    ...
    const loadOrderDetails = (orderid) => {
        OrderDetailsMaterialProcu(orderid).then(res => {
            if (res !== undefined) {
                if (res.data.success) {
    ...
    return (
        <>
            <PageTitle
                breadCrumbItems={[
                    { label: "Orders", path: "/material-procurement/orders" },
                    {
                        label: 'Details',
                        path: '',
                        active: true,
...
export default MaterialProcuOrderDetails;