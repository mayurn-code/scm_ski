...
// main component
const InventoryDailyProduction = ({ orderid }): React$Element<React$FragmentType> => {
    return (
        <>
            <PageTitle
                breadCrumbItems={[
                                ...
                                <Col sm={4}>
                                    <div className='d-flex justify-content-end'>
                                        <Link to={`add`} className="btn btn-primary mb-2">
                                            <i className="dripicons-plus me-2"></i>Add Production
                                        </Link>
                                    </div>
                                </Col>
                            </Row>
...
export default InventoryDailyProduction;